...
<div class="col-md-8 col-md-offset-2 ">
  <div class="box box-info">
    ...
    <form action="{{ route('product.store') }}" class="from-horizontal" method="post" enctype="multipart/form-data">
      @csrf
      <div class="box-body">
        ...
        <div class="form-group {{ $errors->has('image') ? 'has-error' : '' }}">
          ...
          <div class="col-md-10">
            <input type="file" name="image" class="form-control" value="{{ old('image') }}" placeholder="Please Fill the Price">
            @if ($errors->has('image'))
